...
static KkcDictionaryCallbackReturn __lambda8_ (Block4Data* _data4_, KkcDictionary* dictionary);
...
static KkcDictionaryCallbackReturn __lambda14_ (Block5Data* _data5_, KkcDictionary* dictionary);
...
static KkcDictionaryCallbackReturn __lambda15_ (Block6Data* _data6_, KkcDictionary* dictionary);
...
static KkcDictionaryCallbackReturn __lambda16_ (Block6Data* _data6_, KkcDictionary* dictionary);
...
static KkcDictionaryCallbackReturn __lambda10_ (Block7Data* _data7_, KkcDictionary* dictionary);
...
static KkcDictionaryCallbackReturn __lambda12_ (Block8Data* _data8_, KkcDictionary* dictionary);
...
static KkcDictionaryCallbackReturn __lambda13_ (KkcState* self, KkcDictionary* dictionary);
...
static KkcDictionaryCallbackReturn __lambda11_ (Block9Data* _data9_, KkcDictionary* dictionary);
...
static KkcDictionaryCallbackReturn __lambda9_ (Block10Data* _data10_, KkcDictionary* dictionary);
...
static void kkc_state_candidates_selected (KkcState* self, KkcCandidate* candidate) {
	...
	kkc_dictionary_list_call (_tmp2_, &_tmp3_, ___lambda8__kkc_dictionary_list_dictionary_callback, _data4_);
...
void kkc_state_select_sentence (KkcState* self) {
	...
	kkc_dictionary_list_call (_tmp30_, &_tmp31_, ___lambda14__kkc_dictionary_list_dictionary_callback, _data5_);
...
static KkcDictionaryCallbackReturn ___lambda15__kkc_dictionary_list_dictionary_callback (KkcDictionary* dictionary, gpointer self) {
	KkcDictionaryCallbackReturn result;
	result = __lambda15_ (self, dictionary);
	return result;
}
...
gchar* kkc_state_lookup_single (KkcState* self, const gchar* input) {
	...
	_tmp2_ = self->dictionaries;
	_tmp3_ = KKC_TYPE_SEGMENT_DICTIONARY;
	kkc_dictionary_list_call (_tmp2_, &_tmp3_, ___lambda15__kkc_dictionary_list_dictionary_callback, _data6_);
	_tmp4_ = _data6_->_result_;
	if (_tmp4_ != NULL) {
	...
	kkc_dictionary_list_call (_tmp30_, &_tmp31_, ___lambda16__kkc_dictionary_list_dictionary_callback, _data6_);
...
static void kkc_state_lookup_template (KkcState* self, KkcTemplate* template, gboolean user) {
	...
	kkc_dictionary_list_call (_tmp3_, &_tmp4_, ___lambda10__kkc_dictionary_list_dictionary_callback, _data7_);
...
static void kkc_state_apply_constraint (KkcState* self, const gchar* input) {
	...
	kkc_dictionary_list_call (_tmp2_, &_tmp3_, ___lambda12__kkc_dictionary_list_dictionary_callback, _data8_);
...
static void kkc_state_apply_phrase (KkcState* self) {
	...
	kkc_dictionary_list_call (_tmp0_, &_tmp1_, ___lambda13__kkc_dictionary_list_dictionary_callback, self);
}
...
void kkc_state_purge_candidate (KkcState* self, KkcCandidate* candidate) {
	...
	_tmp2_ = self->dictionaries;
	_tmp3_ = KKC_TYPE_SEGMENT_DICTIONARY;
	kkc_dictionary_list_call (_tmp2_, &_tmp3_, ___lambda11__kkc_dictionary_list_dictionary_callback, _data9_);
...
void kkc_state_completion_start (KkcState* self, const gchar* input) {
	...
	_tmp3_ = self->dictionaries;
	_tmp4_ = KKC_TYPE_SEGMENT_DICTIONARY;
	kkc_dictionary_list_call (_tmp3_, &_tmp4_, ___lambda9__kkc_dictionary_list_dictionary_callback, _data10_);
