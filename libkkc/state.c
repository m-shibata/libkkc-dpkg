/* state.c generated by valac 0.24.0.131-42e78, the Vala compiler
...
void kkc_state_select_sentence (KkcState* self) {
	...
	KkcDictionaryList* _tmp29_ = NULL;
	GType _tmp30_ = 0UL;
	g_return_if_fail (self != NULL);
...
void kkc_state_lookup (KkcState* self, KkcSegment* segment) {
	...
	KkcSegment** _segments = NULL;
	KkcDecoder* _tmp78_ = NULL;
	const gchar* _tmp79_ = NULL;
	gint* _tmp80_ = NULL;
	gint* _tmp81_ = NULL;
	gint _tmp81__length1 = 0;
	gint _tmp82_ = 0;
	KkcSegment** _tmp83_ = NULL;
	...
	KkcCandidateList* _tmp105_ = NULL;
	...
	enum_class = (GEnumClass*) _tmp52_;
	{
		...
		i = _tmp54_;
		{
			...
			while (TRUE) {
				gint _tmp57_ = 0;
				GEnumClass* _tmp58_ = NULL;
				gint _tmp59_ = 0;
				GEnumValue* enum_value = NULL;
				GEnumClass* _tmp60_ = NULL;
				gint _tmp61_ = 0;
				GEnumValue* _tmp62_ = NULL;
				...
				_tmp57_ = i;
				_tmp58_ = enum_class;
				_tmp59_ = _tmp58_->maximum;
				if (!(_tmp57_ <= _tmp59_)) {
					break;
				}
				_tmp60_ = enum_class;
				_tmp61_ = i;
				_tmp62_ = g_enum_get_value (_tmp60_, _tmp61_);
				_tmp63_ = __g_enum_value_dup0 (_tmp62_);
				enum_value = _tmp63_;
				_tmp64_ = enum_value;
				if (_tmp64_ != NULL) {
					gchar* output = NULL;
					const gchar* _tmp65_ = NULL;
					GEnumValue* _tmp66_ = NULL;
					gint _tmp67_ = 0;
					gchar* _tmp68_ = NULL;
					const gchar* _tmp69_ = NULL;
					KkcCandidate* _tmp70_ = NULL;
					const gchar* _tmp71_ = NULL;
					const gchar* _tmp72_ = NULL;
					_tmp65_ = normalized_input;
					_tmp66_ = enum_value;
					_tmp67_ = (*_tmp66_).value;
					_tmp68_ = kkc_rom_kana_utils_convert_by_kana_mode (_tmp65_, (KkcKanaMode) _tmp67_);
					output = _tmp68_;
					_tmp69_ = output;
					_tmp70_ = original;
					_tmp71_ = kkc_candidate_get_output (_tmp70_);
					_tmp72_ = _tmp71_;
					if (g_strcmp0 (_tmp69_, _tmp72_) != 0) {
						KkcCandidate* candidate = NULL;
						const gchar* _tmp73_ = NULL;
						const gchar* _tmp74_ = NULL;
						KkcCandidate* _tmp75_ = NULL;
						KkcCandidateList* _tmp76_ = NULL;
						KkcCandidate* _tmp77_ = NULL;
						_tmp73_ = normalized_input;
						_tmp74_ = output;
						_tmp75_ = kkc_candidate_new (_tmp73_, FALSE, _tmp74_, NULL, NULL);
						candidate = _tmp75_;
						_tmp76_ = kana_candidates;
						_tmp77_ = candidate;
						kkc_candidate_list_add (_tmp76_, _tmp77_);
						_g_object_unref0 (candidate);
					}
					_g_free0 (output);
				}
	...
	_tmp78_ = self->decoder;
	_tmp79_ = normalized_input;
	_tmp80_ = g_new0 (gint, 0);
	_tmp81_ = _tmp80_;
	_tmp81__length1 = 0;
	_tmp83_ = kkc_decoder_decode_with_costs (_tmp78_, _tmp79_, KKC_DECODER_NBEST, _tmp81_, 0, KKC_DECODER_MAX_DISTANCE, KKC_DECODER_MIN_PATH_COST, &_tmp82_);
	_tmp84_ = _tmp83_;
	_tmp84__length1 = _tmp82_;
	_tmp81_ = (g_free (_tmp81_), NULL);
	_segments = _tmp84_;
	_segments_length1 = _tmp84__length1;
	__segments_size_ = _segments_length1;
	_tmp85_ = _segments;
	_tmp85__length1 = _segments_length1;
	{
		KkcSegment** _segment_collection = NULL;
		gint _segment_collection_length1 = 0;
		gint __segment_collection_size_ = 0;
		gint _segment_it = 0;
		_segment_collection = _tmp85_;
		_segment_collection_length1 = _tmp85__length1;
		for (_segment_it = 0; _segment_it < _tmp85__length1; _segment_it = _segment_it + 1) {
			KkcSegment* _tmp86_ = NULL;
			KkcSegment* _segment = NULL;
			_tmp86_ = _g_object_ref0 (_segment_collection[_segment_it]);
			_segment = _tmp86_;
			{
				GString* builder = NULL;
				...
				KkcCandidate* _tmp99_ = NULL;
				KkcCandidateList* _tmp100_ = NULL;
				KkcCandidate* _tmp101_ = NULL;
				gboolean _tmp102_ = FALSE;
				_tmp87_ = g_string_new ("");
				builder = _tmp87_;
				while (TRUE) {
					KkcSegment* _tmp88_ = NULL;
					GString* _tmp89_ = NULL;
					KkcSegment* _tmp90_ = NULL;
					const gchar* _tmp91_ = NULL;
					const gchar* _tmp92_ = NULL;
					KkcSegment* _tmp93_ = NULL;
					...
					_tmp89_ = builder;
					_tmp90_ = _segment;
					_tmp91_ = kkc_segment_get_output (_tmp90_);
					_tmp92_ = _tmp91_;
				...
				_tmp96_ = normalized_input;
				_tmp97_ = builder;
				_tmp98_ = _tmp97_->str;
				_tmp99_ = kkc_candidate_new (_tmp96_, FALSE, _tmp98_, NULL, NULL);
				sentence = _tmp99_;
				_tmp100_ = kana_candidates;
				_tmp101_ = sentence;
				_tmp102_ = kkc_candidate_list_contains (_tmp100_, _tmp101_);
				if (!_tmp102_) {
					KkcCandidateList* _tmp103_ = NULL;
					KkcCandidate* _tmp104_ = NULL;
					_tmp103_ = self->candidates;
					_tmp104_ = sentence;
					kkc_candidate_list_add (_tmp103_, _tmp104_);
				}
	...
	_tmp105_ = self->candidates;
	_tmp106_ = kana_candidates;
	kkc_candidate_list_add_all (_tmp105_, _tmp106_);
	_tmp107_ = self->candidates;
	g_signal_emit_by_name (_tmp107_, "populated");
	_segments = (_vala_array_free (_segments, _segments_length1, (GDestroyNotify) g_object_unref), NULL);
...
static KkcDictionaryCallbackReturn __lambda12_ (Block7Data* _data7_, KkcDictionary* dictionary) {
	...
	KkcDictionary* _tmp3_ = NULL;
	KkcTemplate* _tmp4_ = NULL;
	self = _data7_->self;
	g_return_val_if_fail (dictionary != NULL, 0);
	_tmp1_ = _data7_->user;
	if (_tmp1_) {
...
static void kkc_state_merge_possible_okurigana_segments (KkcState* self, gint start) {
	...
	KkcSegment* _tmp84_ = NULL;
	g_return_if_fail (self != NULL);
	_tmp0_ = gee_array_list_new (KKC_TYPE_SEGMENT, (GBoxedCopyFunc) g_object_ref, g_object_unref, NULL, NULL, NULL);
	_segments = _tmp0_;
	{
...
static void kkc_state_apply_constraint_for_dictionary (KkcState* self, KkcDictionary* dictionary, const gchar* input) {
	...
	gint _tmp140_ = 0;
	KkcSegment** _tmp141_ = NULL;
	KkcSegment** _tmp142_ = NULL;
	gint _tmp142__length1 = 0;
	gint _segments_length1 = 0;
	gint __segments_size_ = 0;
	KkcSegmentList* _tmp143_ = NULL;
	KkcSegment* _tmp144_ = NULL;
	g_return_if_fail (self != NULL);
	g_return_if_fail (dictionary != NULL);
	g_return_if_fail (input != NULL);
	_tmp0_ = dictionary;
...
static void kkc_state_apply_phrase_for_dictionary (KkcState* self, KkcDictionary* dictionary) {
	...
	offset = 0;
	{
		...
		while (TRUE) {
			...
			KkcPrefixEntry* _tmp39_ = NULL;
			gint _tmp40_ = 0;
			gint _tmp41_ = 0;
			gchar** _value = NULL;
			gint _value_length1 = 0;
			gint __value_size_ = 0;
			KkcSentenceDictionary* _tmp42_ = NULL;
			KkcPrefixEntry* _tmp43_ = NULL;
			gchar** _tmp44_ = NULL;
...
void kkc_state_resize_segment (KkcState* self, gint amount) {
	...
	if (_tmp0_) {
		...
		gint cursor_pos = 0;
		KkcSegmentList* _tmp69_ = NULL;
		gint _tmp70_ = 0;
		gint _tmp71_ = 0;
		KkcSegmentList* _tmp72_ = NULL;
		gchar* _tmp73_ = NULL;
		gchar* _tmp74_ = NULL;
		gint* _tmp75_ = NULL;
...
gboolean kkc_state_handler_dispatch_command (KkcStateHandler* self, KkcState* state, KkcKeyEvent* key) {
	...
	gboolean _tmp3_ = FALSE;
	const gchar* _tmp4_ = NULL;
	KkcCommandHandler* _tmp17_ = NULL;
	const gchar* _tmp18_ = NULL;
	...
	if (_tmp3_) {
		...
		KkcCommandHandler* _tmp11_ = NULL;
		const gchar* _tmp12_ = NULL;
		KkcState* _tmp13_ = NULL;
		KkcKeyEvent* _tmp14_ = NULL;
		gboolean _tmp15_ = FALSE;
		gboolean _tmp16_ = FALSE;
		_tmp8_ = self->priv->command_handlers;
		_tmp9_ = command;
		_tmp10_ = gee_map_get (_tmp8_, _tmp9_);
		_tmp11_ = (KkcCommandHandler*) _tmp10_;
		_tmp12_ = command;
		_tmp13_ = state;
		_tmp14_ = key;
		_tmp15_ = kkc_command_handler_call (_tmp11_, _tmp12_, _tmp13_, _tmp14_);
		_tmp16_ = _tmp15_;
	...
	_tmp17_ = self->priv->default_command_handler;
	_tmp18_ = command;
	_tmp19_ = state;
	_tmp20_ = key;
	_tmp21_ = kkc_command_handler_call (_tmp17_, _tmp18_, _tmp19_, _tmp20_);
	result = _tmp21_;
	_g_free0 (command);
	return result;
}
...
static void kkc_state_handler_class_init (KkcStateHandlerClass * klass) {
	...
	((KkcStateHandlerClass *) klass)->process_key_event = kkc_state_handler_real_process_key_event;
...
static void kkc_state_handler_instance_init (KkcStateHandler * self) {
	...
	_tmp0_ = gee_hash_map_new (G_TYPE_STRING, (GBoxedCopyFunc) g_strdup, g_free, KKC_TYPE_COMMAND_HANDLER, (GBoxedCopyFunc) g_object_ref, g_object_unref, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
