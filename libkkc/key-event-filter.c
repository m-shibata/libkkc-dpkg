/* key-event-filter.c generated by valac 0.24.0.131-42e78, the Vala compiler
...
static void kkc_key_event_filter_class_init (KkcKeyEventFilterClass * klass) {
	...
	((KkcKeyEventFilterClass *) klass)->filter_key_event = kkc_key_event_filter_real_filter_key_event;
	((KkcKeyEventFilterClass *) klass)->reset = kkc_key_event_filter_real_reset;
	/**
...
static void kkc_simple_key_event_filter_class_init (KkcSimpleKeyEventFilterClass * klass) {
	...
	((KkcKeyEventFilterClass *) klass)->filter_key_event = kkc_simple_key_event_filter_real_filter_key_event;
}
...
static KkcKeyEvent* kkc_kana_key_event_filter_real_filter_key_event (KkcKeyEventFilter* base, KkcKeyEvent* key) {
	...
	if (_tmp3_) {
		...
		_tmp10_ = _key;
		_tmp11_ = kkc_key_event_get_keycode (_tmp10_);
		_tmp12_ = _tmp11_;
		_tmp13_ = _key;
		_tmp14_ = kkc_key_event_get_modifiers (_tmp13_);
		_tmp15_ = _tmp14_;
		_tmp16_ = kkc_key_event_new_from_x_event (KKC_KEYSYMS_yen, _tmp12_, _tmp15_);
		result = _tmp16_;
		_g_object_unref0 (_key);
		return result;
	}
...
static void kkc_kana_key_event_filter_class_init (KkcKanaKeyEventFilterClass * klass) {
	...
	((KkcKeyEventFilterClass *) klass)->filter_key_event = kkc_kana_key_event_filter_real_filter_key_event;
}
