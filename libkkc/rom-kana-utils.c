/* rom-kana-utils.c generated by valac 0.24.0.131-42e78, the Vala compiler
...
static void __lambda7_ (Block1Data* _data1_, gunichar uc);
static void ___lambda7__gfunc (gconstpointer data, gpointer self);
static Block2Data* block2_data_ref (Block2Data* _data2_);
static void block2_data_unref (void * _userdata_);
static void __lambda6_ (Block2Data* _data2_, gunichar uc);
...
static void __lambda8_ (Block3Data* _data3_, gunichar uc);
...
static gchar* kkc_rom_kana_utils_get_okurigana_prefix_for_char (gunichar uc) {
	...
	if (_tmp0_ == 12435U) {
		...
		if (_tmp2_) {
			...
			gchar* _tmp7_ = NULL;
			_tmp5_ = uc;
			_tmp6_ = KKC_ROM_KANA_UTILS_KanaRomTable[_tmp5_ - 12353U];
...
gchar* kkc_rom_kana_utils_get_okurigana_prefix (const gchar* okurigana) {
	...
	if (_tmp2_) {
		...
		gunichar _tmp9_ = 0U;
		_tmp5_ = okurigana;
		_tmp6_ = string_index_of_nth_char (_tmp5_, (glong) 1);
		index = _tmp6_;
		_tmp7_ = okurigana;
		_tmp8_ = index;
	...
	_tmp10_ = head;
	_tmp11_ = kkc_rom_kana_utils_get_okurigana_prefix_for_char (_tmp10_);
	result = _tmp11_;
	return result;
}
...
gunichar kkc_rom_kana_utils_get_wide_latin_char (gunichar uc) {
	...
	if (_tmp0_) {
		...
		gunichar _tmp5_ = 0U;
		_tmp3_ = uc;
		_tmp4_ = KKC_ROM_KANA_UTILS_WideLatinTable[_tmp3_ - 32];
...
static void ___lambda7__gfunc (gconstpointer data, gpointer self) {
	__lambda7_ (self, (gunichar) ((gintptr) data));
}
...
gchar* kkc_rom_kana_utils_get_katakana (const gchar* kana) {
	...
	_tmp1_ = kana;
	kkc_rom_kana_utils_foreach_katakana (_tmp1_, ___lambda7__gfunc, _data1_);
...
gchar* kkc_rom_kana_utils_get_hiragana (const gchar* kana) {
	...
	_tmp1_ = kana;
	kkc_rom_kana_utils_foreach_katakana (_tmp1_, ___lambda6__gfunc, _data2_);
...
static void ___lambda8__gfunc (gconstpointer data, gpointer self) {
	__lambda8_ (self, (gunichar) ((gintptr) data));
}
...
gchar* kkc_rom_kana_utils_get_hankaku_katakana (const gchar* kana) {
	...
	_tmp1_ = kana;
	kkc_rom_kana_utils_foreach_katakana (_tmp1_, ___lambda8__gfunc, _data3_);
		...
		gchar* _tmp14_ = NULL;
		{
			...
			index = 0;
			{
				...
				while (TRUE) {
					...
					_tmp8_ = builder;
					_tmp9_ = num_table;
					_tmp9__length1 = num_table_length1;
					_tmp10_ = uc;
					_tmp11_ = _tmp9_[_tmp10_ - '0'];
			...
			index = 0;
			{
				...
				while (TRUE) {
					...
					if (_tmp19_ > ((gunichar) '0')) {
						...
						_tmp22_ = _tmp21_;
						_tmp23_ = index;
						pos_index = _tmp22_ - _tmp23_;
						_tmp25_ = uc;
						if (_tmp25_ != ((gunichar) '1')) {
							_tmp24_ = TRUE;
						} else {
							gint _tmp26_ = 0;
							_tmp26_ = pos_index;
						...
						if (_tmp24_) {
							...
							_tmp27_ = builder;
							_tmp28_ = uc;
							_tmp29_ = KKC_ROM_KANA_UTILS_KanjiNumericTable[_tmp28_ - '0'];
							g_string_append (_tmp27_, _tmp29_);
						}
						_tmp30_ = num_pos_table;
						_tmp30__length1 = num_pos_table_length1;
						_tmp31_ = pos_index;
						...
						if (_tmp34_) {
							...
							gchar* _tmp40_ = NULL;
							_tmp37_ = num_pos_table;
							_tmp37__length1 = num_pos_table_length1;
							_tmp38_ = pos_index;
							_tmp39_ = _tmp37_[_tmp38_ % 4];
						...
						if (_tmp41_ != NULL) {
							...
							_tmp42_ = builder;
							_tmp43_ = pos;
							g_string_append (_tmp42_, _tmp43_);
						}
						_g_free0 (pos);
					}
				}
...
static void kkc_rom_kana_utils_class_init (KkcRomKanaUtilsClass * klass) {
	...
	_tmp0_ = gee_hash_map_new (G_TYPE_UINT, NULL, NULL, G_TYPE_STRING, (GBoxedCopyFunc) g_strdup, g_free, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
	...
	_tmp2_ = gee_hash_map_new (G_TYPE_UINT, NULL, NULL, G_TYPE_STRING, (GBoxedCopyFunc) g_strdup, g_free, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
	kkc_rom_kana_utils__HankakuKatakanaTable = (GeeMap*) _tmp2_;
	_tmp3_ = gee_hash_map_new (G_TYPE_UINT, NULL, NULL, GEE_TYPE_HASH_MAP, (GBoxedCopyFunc) g_object_ref, g_object_unref, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
	kkc_rom_kana_utils__CompositionTable = (GeeMap*) _tmp3_;
	_tmp4_ = gee_hash_map_new (G_TYPE_STRING, (GBoxedCopyFunc) g_strdup, g_free, G_TYPE_CHAR, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
				...
				if (_tmp21_ != NULL) {
					...
					if (_tmp24_ > 1) {
						...
						if (!_tmp33_) {
							...
							_tmp35_ = uc0;
							_tmp36_ = gee_hash_map_new (G_TYPE_UINT, NULL, NULL, G_TYPE_UINT, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
							_tmp37_ = _tmp36_;
				...
				if (_tmp52_ != NULL) {
					...
					if (_tmp55_ > 1) {
						...
						if (!_tmp64_) {
							...
							_tmp66_ = uc0;
							_tmp67_ = gee_hash_map_new (G_TYPE_UINT, NULL, NULL, G_TYPE_UINT, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
							_tmp68_ = _tmp67_;
	...
	}
	{
		...
		i = 0;
		{
			...
			while (TRUE) {
				...
				_tmp86_ = FALSE;
				_tmp88_ = i;
				if (!(_tmp88_ < G_N_ELEMENTS (KKC_ROM_KANA_UTILS_WideLatinTable))) {
					break;
				}
				_tmp89_ = kkc_rom_kana_utils__WideLatinToLatinTable;
				_tmp90_ = i;
				_tmp91_ = KKC_ROM_KANA_UTILS_WideLatinTable[_tmp90_];
				_tmp92_ = i;
				gee_map_set (_tmp89_, _tmp91_, (gpointer) ((gintptr) ((gchar) (_tmp92_ + 32))));
			}
		}
	}
}
