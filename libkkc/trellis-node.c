...
static void kkc_trellis_node_class_init (KkcTrellisNodeClass * klass) {
	...
	((KkcTrellisNodeClass *) klass)->finalize = kkc_trellis_node_finalize;
	((KkcTrellisNodeClass *) klass)->to_string = kkc_trellis_node_real_to_string;
}
...
static void kkc_unigram_trellis_node_class_init (KkcUnigramTrellisNodeClass * klass) {
	...
	((KkcTrellisNodeClass *) klass)->finalize = kkc_unigram_trellis_node_finalize;
	g_type_class_add_private (klass, sizeof (KkcUnigramTrellisNodePrivate));
	((KkcTrellisNodeClass *) klass)->to_string = kkc_unigram_trellis_node_real_to_string;
...
static void kkc_bigram_trellis_node_class_init (KkcBigramTrellisNodeClass * klass) {
	...
	((KkcTrellisNodeClass *) klass)->finalize = kkc_bigram_trellis_node_finalize;
	g_type_class_add_private (klass, sizeof (KkcBigramTrellisNodePrivate));
	((KkcTrellisNodeClass *) klass)->to_string = kkc_bigram_trellis_node_real_to_string;
