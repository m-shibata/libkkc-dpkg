/* convert-sentence-state-handler.c generated by valac 0.21.1.40-3bbfb, the Vala compiler
...
static gboolean kkc_convert_sentence_state_handler_do_ (KkcConvertSentenceStateHandler* self, const gchar* command, KkcState* state, KkcKeyEvent* key) {
	...
	if (_tmp10_ == NULL) {
		...
		_tmp12_ = key;
		_tmp13_ = kkc_key_event_get_modifiers (_tmp12_);
		_tmp14_ = _tmp13_;
		if (_tmp14_ == 0) {
			_tmp11_ = TRUE;
		} else {
			...
			_tmp15_ = key;
			_tmp16_ = kkc_key_event_get_modifiers (_tmp15_);
			_tmp17_ = _tmp16_;
			_tmp11_ = _tmp17_ == KKC_MODIFIER_TYPE_SHIFT_MASK;
		}
		_tmp18_ = _tmp11_;
		_tmp9_ = _tmp18_;
	} else {
