/* nicola.c generated by valac 0.24.0.131-42e78, the Vala compiler
...
static KkcKeyEvent* kkc_nicola_key_event_filter_queue (KkcNicolaKeyEventFilter* self, KkcKeyEvent* key, gint64 time, gint64* wait) {
	...
	gint64 _tmp64_ = 0LL;
	KkcNicolaKeyEventFilterTimedEntry* _tmp65_ = NULL;
	KkcNicolaKeyEventFilterTimedEntry* _tmp66_ = NULL;
	gint64 _tmp67_ = 0LL;
	...
	if (_tmp1_) {
		...
		KkcNicolaKeyEventFilterTimedEntry* _tmp10_ = NULL;
		...
		_tmp10_ = (KkcNicolaKeyEventFilterTimedEntry*) _tmp9_;
		_tmp11_ = _tmp10_->data;
		_tmp12_ = kkc_key_event_get_keyval ((KkcKeyEvent*) _tmp11_);
		_tmp13_ = _tmp12_;
		_tmp14_ = key;
		_tmp15_ = kkc_key_event_get_keyval (_tmp14_);
		_tmp16_ = _tmp15_;
		_tmp0_ = _tmp13_ == _tmp16_;
		_kkc_nicola_key_event_filter_timed_entry_unref0 (_tmp10_);
	} else {
		_tmp0_ = FALSE;
	}
	if (_tmp0_) {
		...
		KkcNicolaKeyEventFilterTimedEntry* _tmp23_ = NULL;
		...
		entry = (KkcNicolaKeyEventFilterTimedEntry*) _tmp18_;
		_tmp19_ = key;
		_tmp20_ = time;
		_tmp21_ = kkc_nicola_key_event_filter_get_next_wait (self, _tmp19_, _tmp20_);
		_vala_wait = _tmp21_;
		_tmp22_ = self->priv->pending;
		gee_abstract_collection_clear ((GeeAbstractCollection*) _tmp22_);
		_tmp23_ = entry;
		_tmp24_ = _tmp23_->data;
		_tmp25_ = _g_object_ref0 ((KkcKeyEvent*) _tmp24_);
		result = _tmp25_;
	...
	if (_tmp29_ > 0) {
		...
		KkcNicolaKeyEventFilterTimedEntry* _tmp32_ = NULL;
		gconstpointer _tmp33_ = NULL;
		guint _tmp34_ = 0U;
		guint _tmp35_ = 0U;
		KkcKeyEvent* _tmp36_ = NULL;
		guint _tmp37_ = 0U;
		guint _tmp38_ = 0U;
		_tmp30_ = self->priv->pending;
		_tmp31_ = gee_abstract_list_get ((GeeAbstractList*) _tmp30_, 0);
		_tmp32_ = (KkcNicolaKeyEventFilterTimedEntry*) _tmp31_;
		_tmp33_ = _tmp32_->data;
		_tmp34_ = kkc_key_event_get_keyval ((KkcKeyEvent*) _tmp33_);
		_tmp35_ = _tmp34_;
		_tmp36_ = key;
		_tmp37_ = kkc_key_event_get_keyval (_tmp36_);
		_tmp38_ = _tmp37_;
		_tmp26_ = _tmp35_ == _tmp38_;
		_kkc_nicola_key_event_filter_timed_entry_unref0 (_tmp32_);
	} else {
		_tmp26_ = FALSE;
	}
	if (_tmp26_) {
		...
		KkcKeyEvent* _tmp47_ = NULL;
		_tmp39_ = self->priv->pending;
		_tmp40_ = gee_abstract_list_get ((GeeAbstractList*) _tmp39_, 0);
		_tmp41_ = (KkcNicolaKeyEventFilterTimedEntry*) _tmp40_;
		_tmp42_ = time;
		_tmp41_->time = _tmp42_;
		_kkc_nicola_key_event_filter_timed_entry_unref0 (_tmp41_);
		_tmp43_ = key;
		_tmp44_ = time;
		_tmp45_ = kkc_nicola_key_event_filter_get_next_wait (self, _tmp43_, _tmp44_);
		_vala_wait = _tmp45_;
		_tmp46_ = key;
	...
	if (_tmp50_ > 2) {
		...
		GeeBidirListIterator* _tmp53_ = NULL;
		_tmp51_ = self->priv->pending;
		_tmp52_ = gee_abstract_bidir_list_bidir_list_iterator ((GeeAbstractBidirList*) _tmp51_);
		iter = _tmp52_;
		_tmp53_ = iter;
		gee_bidir_iterator_last ((GeeBidirIterator*) _tmp53_);
		{
			...
			_tmp54_ = TRUE;
			while (TRUE) {
				GeeBidirListIterator* _tmp61_ = NULL;
				if (!_tmp54_) {
					...
					if (_tmp58_ > 2) {
						...
						_tmp59_ = iter;
						_tmp60_ = gee_bidir_iterator_previous ((GeeBidirIterator*) _tmp59_);
						_tmp55_ = _tmp60_;
					} else {
						_tmp55_ = FALSE;
					}
				...
				_tmp54_ = FALSE;
				_tmp61_ = iter;
				gee_iterator_remove ((GeeIterator*) _tmp61_);
			}
		}
		_g_object_unref0 (iter);
	}
	_tmp62_ = self->priv->pending;
	_tmp63_ = key;
	_tmp64_ = time;
	_tmp65_ = kkc_nicola_key_event_filter_timed_entry_new (KKC_TYPE_KEY_EVENT, (GBoxedCopyFunc) g_object_ref, g_object_unref, _tmp63_, _tmp64_);
	_tmp66_ = _tmp65_;
	gee_abstract_list_insert ((GeeAbstractList*) _tmp62_, 0, _tmp66_);
	_kkc_nicola_key_event_filter_timed_entry_unref0 (_tmp66_);
	_tmp67_ = self->timeout;
	_vala_wait = _tmp67_;
	result = NULL;
	if (wait) {
		*wait = _vala_wait;
...
static gint64 kkc_nicola_key_event_filter_get_next_wait (KkcNicolaKeyEventFilter* self, KkcKeyEvent* key, gint64 time) {
	...
	if (_tmp2_ > 0) {
		...
		GeeBidirListIterator* _tmp5_ = NULL;
		...
		gee_bidir_iterator_last ((GeeBidirIterator*) _tmp5_);
		{
			...
			while (TRUE) {
				KkcNicolaKeyEventFilterTimedEntry* entry = NULL;
				GeeBidirListIterator* _tmp9_ = NULL;
				gpointer _tmp10_ = NULL;
				gint64 _tmp11_ = 0LL;
				KkcNicolaKeyEventFilterTimedEntry* _tmp12_ = NULL;
				gint64 _tmp13_ = 0LL;
				gint64 _tmp14_ = 0LL;
				if (!_tmp6_) {
					GeeBidirListIterator* _tmp7_ = NULL;
					gboolean _tmp8_ = FALSE;
					_tmp7_ = iter;
					_tmp8_ = gee_bidir_iterator_previous ((GeeBidirIterator*) _tmp7_);
					if (!_tmp8_) {
						break;
					}
				}
				...
				entry = (KkcNicolaKeyEventFilterTimedEntry*) _tmp10_;
				_tmp11_ = time;
				_tmp12_ = entry;
				_tmp13_ = _tmp12_->time;
				_tmp14_ = self->timeout;
				if ((_tmp11_ - _tmp13_) > _tmp14_) {
					GeeBidirListIterator* _tmp15_ = NULL;
					_tmp15_ = iter;
					gee_iterator_remove ((GeeIterator*) _tmp15_);
				}
				_kkc_nicola_key_event_filter_timed_entry_unref0 (entry);
			}
		}
	...
	if (_tmp18_ > 0) {
		...
		gint64 _tmp24_ = 0LL;
		gint64 _tmp25_ = 0LL;
		_tmp19_ = self->timeout;
		_tmp20_ = time;
		_tmp21_ = self->priv->pending;
		_tmp22_ = gee_linked_list_last (_tmp21_);
		_tmp23_ = (KkcNicolaKeyEventFilterTimedEntry*) _tmp22_;
		_tmp24_ = _tmp23_->time;
		_tmp25_ = _tmp19_ - (_tmp20_ - _tmp24_);
		_kkc_nicola_key_event_filter_timed_entry_unref0 (_tmp23_);
		result = _tmp25_;
		return result;
	} else {
		gint64 _tmp26_ = 0LL;
		_tmp26_ = self->maxwait;
		result = _tmp26_;
		return result;
	}
}
		...
		if (_tmp46_ == 2) {
			...
			if ((_tmp52_ - _tmp54_) > _tmp55_) {
				...
				if (_tmp66_) {
					...
					KkcNicolaKeyEventFilterTimedEntry* _tmp74_ = NULL;
					gconstpointer _tmp75_ = NULL;
					gboolean _tmp76_ = FALSE;
					_tmp74_ = a;
					_tmp75_ = _tmp74_->data;
					_tmp76_ = kkc_nicola_key_event_filter_is_shift ((KkcKeyEvent*) _tmp75_);
					if (_tmp76_) {
						KkcNicolaKeyEventFilterTimedEntry* _tmp77_ = NULL;
						gconstpointer _tmp78_ = NULL;
						gboolean _tmp79_ = FALSE;
						_tmp77_ = b;
						_tmp78_ = _tmp77_->data;
						_tmp79_ = kkc_nicola_key_event_filter_is_shift ((KkcKeyEvent*) _tmp78_);
						_tmp73_ = _tmp79_;
					} else {
						_tmp73_ = FALSE;
					}
				...
				if (_tmp65_) {
					...
					KkcNicolaKeyEventFilterTimedEntry* _tmp82_ = NULL;
					KkcKeyEvent* r = NULL;
					gint64 _tmp83_ = 0LL;
					KkcKeyEvent* _tmp84_ = NULL;
					KkcKeyEvent* output = NULL;
					KkcNicolaKeyEventFilterTimedEntry* _tmp85_ = NULL;
					gconstpointer _tmp86_ = NULL;
					KkcKeyEvent* _tmp87_ = NULL;
					KkcKeyEvent* _tmp88_ = NULL;
					_tmp80_ = self->priv->pending;
					gee_abstract_collection_clear ((GeeAbstractCollection*) _tmp80_);
					_tmp81_ = self->priv->pending;
					_tmp82_ = b;
					gee_deque_offer_head ((GeeDeque*) _tmp81_, _tmp82_);
					_tmp83_ = time;
					_tmp84_ = kkc_nicola_key_event_filter_dispatch_single (self, _tmp83_);
					r = _tmp84_;
					_tmp85_ = a;
					_tmp86_ = _tmp85_->data;
					_tmp87_ = kkc_nicola_key_event_filter_decompose_shifted (self, (KkcKeyEvent*) _tmp86_);
					output = _tmp87_;
					_tmp88_ = output;
					g_signal_emit_by_name ((KkcKeyEventFilter*) self, "forwarded", _tmp88_);
					result = r;
					_g_object_unref0 (output);
					_kkc_nicola_key_event_filter_timed_entry_unref0 (a);
					_kkc_nicola_key_event_filter_timed_entry_unref0 (b);
					...
					gint64 _tmp89_ = 0LL;
					KkcNicolaKeyEventFilterTimedEntry* _tmp90_ = NULL;
					gint64 _tmp91_ = 0LL;
					gint64 _tmp92_ = 0LL;
					_tmp89_ = time;
					_tmp90_ = a;
					_tmp91_ = _tmp90_->time;
					_tmp92_ = self->timeout;
					if ((_tmp89_ - _tmp91_) > _tmp92_) {
						GeeLinkedList* _tmp93_ = NULL;
						KkcNicolaKeyEventFilterTimedEntry* _tmp94_ = NULL;
						gconstpointer _tmp95_ = NULL;
						gboolean _tmp96_ = FALSE;
						_tmp93_ = self->priv->pending;
						gee_abstract_collection_clear ((GeeAbstractCollection*) _tmp93_);
						_tmp94_ = b;
						_tmp95_ = _tmp94_->data;
						_tmp96_ = kkc_nicola_key_event_filter_is_shift ((KkcKeyEvent*) _tmp95_);
						if (_tmp96_) {
							KkcNicolaKeyEventFilterTimedEntry* _tmp97_ = NULL;
							gconstpointer _tmp98_ = NULL;
							KkcNicolaKeyEventFilterTimedEntry* _tmp99_ = NULL;
							gconstpointer _tmp100_ = NULL;
							KkcNicolaKeyEventFilterTimedEntry* _tmp101_ = NULL;
							gconstpointer _tmp102_ = NULL;
							KkcKeyEvent* _tmp103_ = NULL;
							_tmp97_ = b;
							_tmp98_ = _tmp97_->data;
							_tmp99_ = a;
							_tmp100_ = _tmp99_->data;
							kkc_nicola_key_event_filter_apply_shift (self, (KkcKeyEvent*) _tmp98_, (KkcKeyEvent*) _tmp100_);
							_tmp101_ = a;
							_tmp102_ = _tmp101_->data;
							_tmp103_ = _g_object_ref0 ((KkcKeyEvent*) _tmp102_);
							result = _tmp103_;
							_kkc_nicola_key_event_filter_timed_entry_unref0 (a);
							_kkc_nicola_key_event_filter_timed_entry_unref0 (b);
							return result;
							...
							KkcNicolaKeyEventFilterTimedEntry* _tmp106_ = NULL;
							gconstpointer _tmp107_ = NULL;
							KkcNicolaKeyEventFilterTimedEntry* _tmp108_ = NULL;
							gconstpointer _tmp109_ = NULL;
							KkcKeyEvent* _tmp110_ = NULL;
							_tmp104_ = a;
							_tmp105_ = _tmp104_->data;
							_tmp106_ = b;
							_tmp107_ = _tmp106_->data;
							kkc_nicola_key_event_filter_apply_shift (self, (KkcKeyEvent*) _tmp105_, (KkcKeyEvent*) _tmp107_);
							_tmp108_ = b;
							_tmp109_ = _tmp108_->data;
							_tmp110_ = _g_object_ref0 ((KkcKeyEvent*) _tmp109_);
							result = _tmp110_;
							_kkc_nicola_key_event_filter_timed_entry_unref0 (a);
							_kkc_nicola_key_event_filter_timed_entry_unref0 (b);
							return result;
			...
			GeeLinkedList* _tmp111_ = NULL;
			gint _tmp112_ = 0;
			gint _tmp113_ = 0;
			_tmp111_ = self->priv->pending;
			_tmp112_ = gee_abstract_collection_get_size ((GeeCollection*) _tmp111_);
			_tmp113_ = _tmp112_;
			if (_tmp113_ == 1) {
				gint64 _tmp114_ = 0LL;
				KkcKeyEvent* _tmp115_ = NULL;
				_tmp114_ = time;
				_tmp115_ = kkc_nicola_key_event_filter_dispatch_single (self, _tmp114_);
				result = _tmp115_;
				return result;
			}
		}
...
static gboolean _kkc_nicola_key_event_filter_timeout_func_gsource_func (gpointer self) {
	gboolean result;
	result = kkc_nicola_key_event_filter_timeout_func ((KkcNicolaKeyEventFilter*) self);
	return result;
}
...
static void kkc_nicola_key_event_filter_timed_entry_class_init (KkcNicolaKeyEventFilterTimedEntryClass * klass) {
	...
	((KkcNicolaKeyEventFilterTimedEntryClass *) klass)->finalize = kkc_nicola_key_event_filter_timed_entry_finalize;
...
static void kkc_nicola_key_event_filter_class_init (KkcNicolaKeyEventFilterClass * klass) {
	...
	((KkcKeyEventFilterClass *) klass)->filter_key_event = kkc_nicola_key_event_filter_real_filter_key_event;
	((KkcKeyEventFilterClass *) klass)->reset = kkc_nicola_key_event_filter_real_reset;
...
static void kkc_nicola_key_event_filter_instance_init (KkcNicolaKeyEventFilter * self) {
	...
	_tmp0_ = gee_linked_list_new (KKC_NICOLA_KEY_EVENT_FILTER_TYPE_TIMED_ENTRY, (GBoxedCopyFunc) kkc_nicola_key_event_filter_timed_entry_ref, kkc_nicola_key_event_filter_timed_entry_unref, NULL, NULL, NULL);
