/* kkc-internals-1.0.vapi generated by valac 0.21.1.40-3bbfb, do not modify. */

namespace Kkc {
	namespace LanguageModelUtils {
		[CCode (cheader_filename = "libkkc/libkkc-internals.h")]
		internal static double decode_cost (uint16 cost, double min_cost);
		[CCode (cheader_filename = "libkkc/libkkc-internals.h")]
		internal static long bsearch_ngram (void* memory, long start_offset, long end_offset, long record_size, uint8[] needle);
	}
	namespace Keysyms {
		[CCode (cheader_filename = "libkkc/libkkc-internals.h")]
	...
	namespace SequenceUtils {
		[CCode (cheader_filename = "libkkc/libkkc-internals.h")]
		internal static Gee.List<Kkc.PrefixEntry?> enumerate_prefixes (string[] sequence, int min, int max);
	}
	[CCode (cheader_filename = "libkkc/libkkc-internals.h")]
	public abstract class MetadataFile : GLib.Object, GLib.Initable {
		public MetadataFile (string name, string filename) throws GLib.Error;
		public abstract bool parse (Json.Object object) throws GLib.Error;
	...
	public abstract class TrellisNode {
		public Kkc.TrellisNode? previous;
		...
		public abstract Kkc.LanguageModelEntry[] entries { get; }
	}
	[CCode (cheader_filename = "libkkc/libkkc-internals.h")]
	public class UnigramTrellisNode : Kkc.TrellisNode {
		public UnigramTrellisNode (Kkc.LanguageModelEntry entry, uint endpos);
		public override string to_string ();
		public Kkc.LanguageModelEntry entry { get; }
		public override string input { get; }
		public override string output { get; }
		public override uint endpos { get; }
		public override uint length { get; }
		public override Kkc.LanguageModelEntry[] entries { get; }
	}
	[CCode (cheader_filename = "libkkc/libkkc-internals.h")]
	public class BigramTrellisNode : Kkc.TrellisNode {
		public BigramTrellisNode (Kkc.UnigramTrellisNode left_node, Kkc.UnigramTrellisNode right_node, uint endpos);
		public override string to_string ();
		public Kkc.UnigramTrellisNode left_node { get; }
		public Kkc.UnigramTrellisNode right_node { get; }
		public override string input { get; }
		public override string output { get; }
		public override uint endpos { get; }
		public override uint length { get; }
	...
	[CCode (cheader_filename = "libkkc/libkkc-internals.h")]
	public class LanguageModelMetadata : Kkc.MetadataFile {
		public LanguageModelMetadata (string name, string filename) throws GLib.Error;
		public override bool parse (Json.Object object) throws GLib.Error;
		public static Kkc.LanguageModelMetadata? find (string name);
		public Kkc.LanguageModel? create_language_model () throws GLib.Error;
		public GLib.Type model_type { get; set construct; }
	}
	[CCode (cheader_filename = "libkkc/libkkc-internals.h")]
	public abstract class LanguageModel : GLib.Object, GLib.Initable {
		public abstract Gee.Collection<Kkc.LanguageModelEntry?> unigram_entries (string input);
		public abstract Gee.Collection<Kkc.LanguageModelEntry?> entries (string input);
		public abstract new Kkc.LanguageModelEntry? @get (string input, string output);
		public LanguageModel (Kkc.LanguageModelMetadata metadata) throws GLib.Error;
		public abstract bool parse () throws GLib.Error;
		public static Kkc.LanguageModel? load (string name) throws GLib.Error;
		public Kkc.LanguageModelMetadata metadata { get; set construct; }
		public abstract Kkc.LanguageModelEntry bos { get; }
		public abstract Kkc.LanguageModelEntry eos { get; }
	}
	[CCode (cheader_filename = "libkkc/libkkc-internals.h")]
	public class TextBigramLanguageModel : Kkc.LanguageModel, Kkc.UnigramLanguageModel, Kkc.BigramLanguageModel {
		protected Gee.Map<string,Gee.ArrayList<Kkc.LanguageModelEntry?>> input_map;
		protected Gee.Map<string,double?> cost_map;
		protected Gee.Map<string,double?> backoff_map;
		protected Gee.Map<string,uint> id_map;
		public override Gee.Collection<Kkc.LanguageModelEntry?> unigram_entries (string input);
		public override Gee.Collection<Kkc.LanguageModelEntry?> entries (string input);
		public override Kkc.LanguageModelEntry? @get (string input, string output);
		protected string get_key (uint[] ids);
		protected void parse_lm (string input) throws GLib.Error;
		public override bool parse () throws GLib.Error;
		public TextBigramLanguageModel (Kkc.LanguageModelMetadata metadata) throws GLib.Error;
		public override Kkc.LanguageModelEntry bos { get; }
		public override Kkc.LanguageModelEntry eos { get; }
	}
	[CCode (cheader_filename = "libkkc/libkkc-internals.h")]
	public class TextTrigramLanguageModel : Kkc.TextBigramLanguageModel, Kkc.TrigramLanguageModel {
		public TextTrigramLanguageModel (Kkc.LanguageModelMetadata metadata) throws GLib.Error;
	}
	[CCode (cheader_filename = "libkkc/libkkc-internals.h")]
	public class SortedBigramLanguageModel : Kkc.LanguageModel, Kkc.UnigramLanguageModel, Kkc.BigramLanguageModel {
		public override Gee.Collection<Kkc.LanguageModelEntry?> unigram_entries (string prefix);
		public override Gee.Collection<Kkc.LanguageModelEntry?> entries (string input);
		public override Kkc.LanguageModelEntry? @get (string input, string output);
		protected long bigram_offset (Kkc.LanguageModelEntry pentry, Kkc.LanguageModelEntry entry);
		public override bool parse () throws GLib.Error;
		public SortedBigramLanguageModel (Kkc.LanguageModelMetadata metadata) throws GLib.Error;
		public override Kkc.LanguageModelEntry bos { get; }
		public override Kkc.LanguageModelEntry eos { get; }
		public double min_cost { get; }
	}
	[CCode (cheader_filename = "libkkc/libkkc-internals.h")]
	public class SortedTrigramLanguageModel : Kkc.SortedBigramLanguageModel, Kkc.TrigramLanguageModel {
		public override bool parse () throws GLib.Error;
		public SortedTrigramLanguageModel (Kkc.LanguageModelMetadata metadata) throws GLib.Error;
	}
	[CCode (cheader_filename = "libkkc/libkkc-internals.h")]
	public abstract class Decoder : GLib.Object {
		public abstract Kkc.Segment[] decode (string input, int nbest, int[] constraint);
		public abstract Kkc.Segment[] decode_with_costs (string input, int nbest, int[] constraint, double max_distance, double min_path_cost);
		public static Kkc.Decoder? create (Kkc.LanguageModel model);
		public Decoder ();
	}
	[CCode (cheader_filename = "libkkc/libkkc-internals.h")]
	internal class NbestNode {
		public Kkc.TrellisNode node;
		public double gn;
		public double fn;
		public Kkc.NbestNode? next;
		public NbestNode (Kkc.TrellisNode node);
	}
	[CCode (cheader_filename = "libkkc/libkkc-internals.h")]
	public class BigramDecoder : Kkc.Decoder {
		public override Kkc.Segment[] decode (string input, int nbest, int[] constraint);
		public override Kkc.Segment[] decode_with_costs (string input, int nbest, int[] constraint, double max_distance, double min_path_cost);
		protected void add_unknown_nodes (Gee.ArrayList<Kkc.TrellisNode>[] trellis, string input, int[] constraint);
		protected Gee.ArrayList<Kkc.TrellisNode>[] build_trellis (string input, int[] constraint);
		protected void forward_search (Gee.ArrayList<Kkc.TrellisNode>[] trellis, string input);
		protected virtual double path_cost (Kkc.TrellisNode pnode, Kkc.TrellisNode node, int endpos);
		protected Kkc.Segment[] backward_search (Gee.ArrayList<Kkc.TrellisNode>[] trellis, int nbest, double max_distance, double min_path_cost);
		public BigramDecoder (Kkc.BigramLanguageModel model);
		public Kkc.BigramLanguageModel model { get; }
	}
	[CCode (cheader_filename = "libkkc/libkkc-internals.h")]
	internal abstract class PathCostFunc {
		public abstract double path_cost (Kkc.TrigramLanguageModel model, Kkc.TrellisNode pnode, Kkc.TrellisNode node);
		public PathCostFunc ();
	}
	[CCode (cheader_filename = "libkkc/libkkc-internals.h")]
	internal class UnigramToUnigramPathCostFunc : Kkc.PathCostFunc {
		public override double path_cost (Kkc.TrigramLanguageModel model, Kkc.TrellisNode pnode, Kkc.TrellisNode node);
		public UnigramToUnigramPathCostFunc ();
	}
	[CCode (cheader_filename = "libkkc/libkkc-internals.h")]
	internal class UnigramToBigramPathCostFunc : Kkc.PathCostFunc {
		public override double path_cost (Kkc.TrigramLanguageModel model, Kkc.TrellisNode pnode, Kkc.TrellisNode node);
		public UnigramToBigramPathCostFunc ();
	}
	[CCode (cheader_filename = "libkkc/libkkc-internals.h")]
	internal class BigramToUnigramPathCostFunc : Kkc.PathCostFunc {
		public override double path_cost (Kkc.TrigramLanguageModel model, Kkc.TrellisNode pnode, Kkc.TrellisNode node);
		public BigramToUnigramPathCostFunc ();
	}
	[CCode (cheader_filename = "libkkc/libkkc-internals.h")]
	internal class BigramToBigramPathCostFunc : Kkc.PathCostFunc {
		public override double path_cost (Kkc.TrigramLanguageModel model, Kkc.TrellisNode pnode, Kkc.TrellisNode node);
		public BigramToBigramPathCostFunc ();
	}
	[CCode (cheader_filename = "libkkc/libkkc-internals.h")]
	public class TrigramDecoder : Kkc.BigramDecoder {
		public override Kkc.Segment[] decode (string input, int nbest, int[] constraint);
		public override Kkc.Segment[] decode_with_costs (string input, int nbest, int[] constraint, double max_distance, double min_path_cost);
		protected override double path_cost (Kkc.TrellisNode pnode, Kkc.TrellisNode node, int endpos);
		public TrigramDecoder (Kkc.TrigramLanguageModel model);
	}
	[CCode (cheader_filename = "libkkc/libkkc-internals.h")]
	public class SegmentList : GLib.Object {
		public void clear ();
		public void add (Kkc.Segment segment);
		public new Kkc.Segment @get (int index);
		public int get_offset (int index);
		public void set_segments (Kkc.Segment segment);
		public bool first_segment ();
		public void next_segment ();
		public void previous_segment ();
		public string get_output ();
		public string get_input ();
		public Kkc.Segment[] to_array ();
		public SegmentList ();
	...
	public class Segment : GLib.Object {
		public Kkc.Segment? next;
		public Segment (string input, string output);
		public string input { get; set construct; }
		public string output { get; set; }
	}
	[CCode (cheader_filename = "libkkc/libkkc-internals.h")]
	internal class BloomFilter : GLib.Object {
		public BloomFilter (string filename) throws GLib.Error;
		public bool contains (uint32 b0, uint32 b1);
	}
	[CCode (cheader_filename = "libkkc/libkkc-internals.h")]
	public class CandidateList : GLib.Object {
		public new Kkc.Candidate @get (int index = -1);
		internal void clear ();
		internal bool contains (Kkc.Candidate candidate);
		internal bool add (Kkc.Candidate candidate);
		internal bool add_all (Kkc.CandidateList other);
		internal Kkc.Candidate[] to_array ();
		...
		public signal void selected (Kkc.Candidate candidate);
	}
	[CCode (cheader_filename = "libkkc/libkkc-internals.h")]
	public class Candidate : GLib.Object {
		...
		public string midasi { get; set construct; }
		public bool okuri { get; set construct; }
	...
	public abstract class KeyEventFilter : GLib.Object {
		public abstract Kkc.KeyEvent? filter_key_event (Kkc.KeyEvent key);
		public virtual void reset ();
		public KeyEventFilter ();
		public signal void forwarded (Kkc.KeyEvent key);
	}
	[CCode (cheader_filename = "libkkc/libkkc-internals.h")]
	internal class SimpleKeyEventFilter : Kkc.KeyEventFilter {
		public override Kkc.KeyEvent? filter_key_event (Kkc.KeyEvent key);
		public SimpleKeyEventFilter ();
	}
	[CCode (cheader_filename = "libkkc/libkkc-internals.h")]
	internal class KanaKeyEventFilter : Kkc.SimpleKeyEventFilter {
		public override Kkc.KeyEvent? filter_key_event (Kkc.KeyEvent key);
		public KanaKeyEventFilter ();
	}
	[CCode (cheader_filename = "libkkc/libkkc-internals.h")]
	public class KeyEvent : GLib.Object {
		public KeyEvent.from_string (string key) throws Kkc.KeyEventFormatError;
		public string to_string ();
		public KeyEvent.from_x_event (uint keyval, uint keycode, Kkc.ModifierType modifiers);
		public KeyEvent (uint keyval, uint keycode, Kkc.ModifierType modifiers);
		public string name { get; set construct; }
		public unichar unicode { get; set construct; }
		public uint keyval { get; set construct; }
		public uint keycode { get; set construct; }
		public Kkc.ModifierType modifiers { get; set construct; }
	}
	[CCode (cheader_filename = "libkkc/libkkc-internals.h")]
	public class Keymap : GLib.Object {
		public static string[] commands ();
		public static string get_command_label (string command);
		public Kkc.KeymapEntry[] entries ();
		public Kkc.KeymapEntry[] local_entries ();
		public new void @set (Kkc.KeyEvent key, string? command);
		public string? lookup_key (Kkc.KeyEvent key);
		public Kkc.KeyEvent? where_is (string command);
		public Keymap ();
		public Kkc.Keymap? parent { get; set; }
	}
	[CCode (cheader_filename = "libkkc/libkkc-internals.h")]
	internal abstract class MapFile : GLib.Object {
		protected virtual string uniquify (string key);
		internal MapFile (Kkc.RuleMetadata metadata, string type, string name) throws Kkc.RuleParseError;
		internal new Gee.Map<string,Json.Node> @get (string name);
		internal new Gee.Map<string,Json.Node> get_parent (string name);
	}
	[CCode (cheader_filename = "libkkc/libkkc-internals.h")]
	public class NicolaKeyEventFilter : Kkc.KeyEventFilter {
		public Kkc.GetTime get_time_func;
	...
	[CCode (cheader_filename = "libkkc/libkkc-internals.h")]
	internal abstract class RomKanaUtils : GLib.Object {
		...
		internal static string convert_by_kana_mode (string str, Kkc.KanaMode mode);
		internal static string get_numeric (int numeric, Kkc.NumericConversionType type);
		internal static bool is_katakana (string str);
		internal static bool is_hiragana (string str);
		public RomKanaUtils ();
	}
	[CCode (cheader_filename = "libkkc/libkkc-internals.h")]
	internal class RomKanaNode : GLib.Object {
		internal Kkc.RomKanaEntry? entry;
		internal weak Kkc.RomKanaNode parent;
		internal Kkc.RomKanaNode children[256];
		internal char c;
		internal uint n_children;
		internal uint8 valid[32];
		internal RomKanaNode (Kkc.RomKanaEntry? entry);
		internal void insert (string key, Kkc.RomKanaEntry entry);
	}
	[CCode (cheader_filename = "libkkc/libkkc-internals.h")]
	public class RomKanaCharacterList : GLib.Object {
		public void add (Kkc.RomKanaCharacter character);
		public void add_all (Kkc.RomKanaCharacterList other);
		public void insert (int index, Kkc.RomKanaCharacter character);
		public void insert_all (int index, Kkc.RomKanaCharacterList other);
		public new Kkc.RomKanaCharacter @get (int index);
		public void clear ();
		public Kkc.RomKanaCharacterList slice (int start_char_pos, int stop_char_pos);
		public void remove_at (int index);
		public string get_output ();
		public string get_input ();
		public RomKanaCharacterList ();
		public int size { get; }
	}
	[CCode (cheader_filename = "libkkc/libkkc-internals.h")]
	public class RomKanaConverter : GLib.Object {
		...
		public void reset ();
		public bool @delete ();
		internal Kkc.RomKanaMapFile rule { get; set; }
		public Kkc.KanaMode kana_mode { get; set; }
		public Kkc.PunctuationStyle punctuation_style { get; set; }
		public bool auto_correct { get; set; }
		public string pending_output { get; }
		public string pending_input { get; }
		public Kkc.RomKanaCharacterList produced { get; }
	}
	[CCode (cheader_filename = "libkkc/libkkc-internals.h")]
	internal class KeymapMapFile : Kkc.MapFile {
		internal Kkc.Keymap keymap;
		internal Kkc.Keymap parent_keymap;
		protected override string uniquify (string key);
		internal KeymapMapFile (Kkc.RuleMetadata metadata, string mode) throws Kkc.RuleParseError;
	}
	[CCode (cheader_filename = "libkkc/libkkc-internals.h")]
	internal class RomKanaMapFile : Kkc.MapFile {
		internal Kkc.RomKanaNode root_node;
		public RomKanaMapFile (Kkc.RuleMetadata metadata) throws Kkc.RuleParseError;
	}
	[CCode (cheader_filename = "libkkc/libkkc-internals.h")]
	public class RuleMetadata : Kkc.MetadataFile {
		public RuleMetadata (string name, string filename) throws GLib.Error;
		public override bool parse (Json.Object object) throws GLib.Error;
		public Kkc.KeyEventFilter create_key_event_filter ();
		public string? locate_map_file (string type, string name);
		public static Kkc.RuleMetadata? find (string name);
		public string filter { get; set construct; }
		public int priority { get; set construct; }
	}
	[CCode (cheader_filename = "libkkc/libkkc-internals.h")]
	public class Rule : GLib.Object, GLib.Initable {
		internal Kkc.RomKanaMapFile rom_kana;
		public Kkc.Keymap get_keymap (Kkc.InputMode mode);
		public Rule (Kkc.RuleMetadata metadata) throws GLib.Error;
		public static Kkc.RuleMetadata[] list ();
		public Kkc.RuleMetadata metadata { get; set construct; }
		public Kkc.KeyEventFilter filter { get; set construct; }
	}
	[CCode (cheader_filename = "libkkc/libkkc-internals.h")]
	public class UserRule : Kkc.Rule {
		public UserRule (Kkc.RuleMetadata parent, string base_dir, string prefix) throws Kkc.RuleParseError, GLib.Error;
		public void write (Kkc.InputMode input_mode) throws GLib.Error;
	}
	[CCode (cheader_filename = "libkkc/libkkc-internals.h")]
	public class Context : GLib.Object {
		public Context (Kkc.LanguageModel model);
		public void set_selection_text (string? text);
		public bool process_key_events (string keyseq) throws Kkc.KeyEventFormatError;
		public bool process_key_event (Kkc.KeyEvent key);
		public void reset ();
		public bool has_output ();
		public string peek_output ();
		public string poll_output ();
		public void clear_output ();
		public Kkc.DictionaryList dictionaries { get; set; }
		public Kkc.CandidateList candidates { get; }
		public Kkc.SegmentList segments { get; }
		public string input { owned get; }
		public int input_cursor_pos { get; }
		public uint input_cursor_width { get; }
		public Kkc.InputMode input_mode { get; set; }
		public Kkc.PunctuationStyle punctuation_style { get; set; }
		public bool auto_correct { get; set; }
		public Kkc.Rule typing_rule { get; set; }
		public Kkc.KeyEventFilter key_event_filter { owned get; }
		public signal void request_selection_text ();
	}
	[CCode (cheader_filename = "libkkc/libkkc-internals.h")]
	internal class State : GLib.Object {
		internal GLib.Type handler_type;
		internal Kkc.LanguageModel model;
		internal Kkc.Decoder decoder;
		internal Kkc.SegmentList segments;
		internal Kkc.CandidateList candidates;
		internal Kkc.DictionaryList dictionaries;
		internal Kkc.RomKanaConverter rom_kana_converter;
		internal Kkc.RomKanaCharacterList input_characters;
		internal int input_characters_cursor_pos;
		internal GLib.StringBuilder selection;
		internal GLib.StringBuilder output;
		internal bool quoted;
		internal Kkc.KeyEvent? this_command_key;
		internal Kkc.KeyEvent? last_command_key;
		internal string? overriding_input;
		internal Gee.Iterator<string> completion_iterator;
		internal void finish_input_editing ();
		internal void convert_segment_by_kana_mode (Kkc.KanaMode mode);
		internal string convert_rom_kana_characters_by_kana_mode (Kkc.RomKanaCharacterList characters, Kkc.KanaMode mode);
		internal string get_input ();
		internal string? lookup_key (Kkc.KeyEvent key);
		internal State (Kkc.LanguageModel model, Kkc.DictionaryList dictionaries);
		internal void select_sentence ();
		internal void reset ();
		internal string? lookup_single (string input);
		internal void lookup (Kkc.Segment segment);
		internal void convert_sentence (string input, int[]? constraint = null);
		internal void resize_segment (int amount);
		internal void purge_candidate (Kkc.Candidate candidate);
		internal void completion_start (string input);
		[CCode (notify = false)]
		internal Kkc.InputMode input_mode { get; set; }
		internal int input_cursor_pos { get; }
		internal uint input_cursor_width { get; }
		internal Kkc.PunctuationStyle punctuation_style { get; set; }
		internal bool auto_correct { get; set; }
		internal Kkc.Rule typing_rule { get; set; }
		public signal void request_selection_text ();
	}
	[CCode (cheader_filename = "libkkc/libkkc-internals.h")]
	internal class CallbackCommandHandler : Kkc.CommandHandler, GLib.Object {
		public CallbackCommandHandler (Kkc.CommandCallback cb);
	}
	[CCode (cheader_filename = "libkkc/libkkc-internals.h")]
	internal abstract class StateHandler : GLib.Object {
		public void register_command_handler (string? command, Kkc.CommandHandler handler);
		public void register_command_callback (string? command, Kkc.CommandCallback cb);
		public bool dispatch_command (Kkc.State state, Kkc.KeyEvent key);
		public abstract bool process_key_event (Kkc.State state, Kkc.KeyEvent key);
		public StateHandler ();
	}
	[CCode (cheader_filename = "libkkc/libkkc-internals.h")]
	internal class InitialStateHandler : Kkc.StateHandler {
		public override bool process_key_event (Kkc.State state, Kkc.KeyEvent key);
		public InitialStateHandler ();
	}
	[CCode (cheader_filename = "libkkc/libkkc-internals.h")]
	internal class ConvertSentenceStateHandler : Kkc.StateHandler {
		public override bool process_key_event (Kkc.State state, Kkc.KeyEvent key);
		public ConvertSentenceStateHandler ();
	}
	[CCode (cheader_filename = "libkkc/libkkc-internals.h")]
	internal class ConvertSegmentStateHandler : Kkc.StateHandler {
		public override bool process_key_event (Kkc.State state, Kkc.KeyEvent key);
		public ConvertSegmentStateHandler ();
	}
	[CCode (cheader_filename = "libkkc/libkkc-internals.h")]
	internal abstract class DictionaryUtils : GLib.Object {
		public static Kkc.Candidate[] split_candidates (string midasi, bool okuri, string line);
		public static string join_candidates (Kkc.Candidate[] candidates);
		public static string escape (string input);
		public static string unescape (string input);
		public DictionaryUtils ();
	}
	[CCode (cheader_filename = "libkkc/libkkc-internals.h")]
	public class EmptySegmentDictionary : GLib.Object, Kkc.Dictionary, Kkc.SegmentDictionary {
		public EmptySegmentDictionary ();
	}
	[CCode (cheader_filename = "libkkc/libkkc-internals.h")]
	public class SystemSegmentDictionary : GLib.Object, Kkc.Dictionary, Kkc.SegmentDictionary {
		public SystemSegmentDictionary (string path, string encoding = "EUC-JP") throws GLib.Error;
	}
	[CCode (cheader_filename = "libkkc/libkkc-internals.h")]
	public class UserSegmentDictionary : GLib.Object, Kkc.Dictionary, Kkc.SegmentDictionary {
		public UserSegmentDictionary (string path) throws GLib.Error;
	}
	[CCode (cheader_filename = "libkkc/libkkc-internals.h")]
	public class UserSentenceDictionary : GLib.Object, Kkc.Dictionary, Kkc.SentenceDictionary {
		public UserSentenceDictionary (string path) throws GLib.Error;
	}
	[CCode (cheader_filename = "libkkc/libkkc-internals.h")]
	public class UserDictionary : GLib.Object, Kkc.Dictionary, Kkc.SegmentDictionary, Kkc.SentenceDictionary {
		public UserDictionary (string basedir) throws GLib.Error;
	}
	[CCode (cheader_filename = "libkkc/libkkc-internals.h")]
	public class DictionaryList : GLib.Object {
		public delegate Kkc.DictionaryCallbackReturn DictionaryCallback (Kkc.Dictionary dictionary);
		public void add (Kkc.Dictionary dictionary);
		public void remove (Kkc.Dictionary dictionary);
		public void clear ();
		public void call (GLib.Type? type, Kkc.DictionaryList.DictionaryCallback callback);
		public void save ();
		public DictionaryList ();
		public int size { get; }
	}
	[CCode (cheader_filename = "libkkc/libkkc-internals.h")]
	internal class EncodingConverter : GLib.Object, GLib.Initable {
	...
	[CCode (cheader_filename = "libkkc/libkkc-internals.h")]
	internal class SimpleTemplate : GLib.Object, Kkc.Template {
		public SimpleTemplate (string source);
	}
	[CCode (cheader_filename = "libkkc/libkkc-internals.h")]
	internal class OkuriganaTemplate : GLib.Object, Kkc.Template {
		public OkuriganaTemplate (string source);
	}
	[CCode (cheader_filename = "libkkc/libkkc-internals.h")]
	internal class NumericTemplate : GLib.Object, Kkc.Template {
		public NumericTemplate (string source);
	}
	[CCode (cheader_filename = "libkkc/libkkc-internals.h")]
	internal class ExpressionReader : GLib.Object {
		public Kkc.ExpressionNode read_symbol (string expr, ref int index);
		public Kkc.ExpressionNode? read_string (string expr, ref int index);
		public Kkc.ExpressionNode? read (string expr, ref int index);
		public ExpressionReader ();
	}
	[CCode (cheader_filename = "libkkc/libkkc-internals.h")]
	internal class ExpressionEvaluator : GLib.Object {
		public string? eval (Kkc.ExpressionNode node);
		public ExpressionEvaluator ();
	}
	[CCode (cheader_filename = "libkkc/libkkc-internals.h")]
	internal abstract class Expression : GLib.Object {
		public static string eval (string text);
		public Expression ();
	}
	[CCode (cheader_filename = "libkkc/libkkc-internals.h")]
	internal abstract class KeyEventUtils : GLib.Object {
	...
	[CCode (cheader_filename = "libkkc/libkkc-internals.h")]
	internal class MappedIndexFile : Kkc.IndexFile, GLib.Object {
		public MappedIndexFile (string filename) throws GLib.Error;
	}
	[CCode (cheader_filename = "libkkc/libkkc-internals.h")]
	internal class LoadedIndexFile : Kkc.IndexFile, GLib.Object {
		public LoadedIndexFile (string filename) throws GLib.Error;
	}
	[CCode (cheader_filename = "libkkc/libkkc-internals.h")]
	public interface UnigramLanguageModel : Kkc.LanguageModel {
		public abstract double unigram_cost (Kkc.LanguageModelEntry entry);
		public abstract double unigram_backoff (Kkc.LanguageModelEntry entry);
	}
	[CCode (cheader_filename = "libkkc/libkkc-internals.h")]
	public interface BigramLanguageModel : Kkc.UnigramLanguageModel {
		public abstract bool has_bigram (Kkc.LanguageModelEntry pentry, Kkc.LanguageModelEntry entry);
		public abstract double bigram_cost (Kkc.LanguageModelEntry pentry, Kkc.LanguageModelEntry entry);
		public abstract double bigram_backoff (Kkc.LanguageModelEntry pentry, Kkc.LanguageModelEntry entry);
		public double bigram_backoff_cost (Kkc.LanguageModelEntry pentry, Kkc.LanguageModelEntry entry);
	}
	[CCode (cheader_filename = "libkkc/libkkc-internals.h")]
	public interface TrigramLanguageModel : Kkc.BigramLanguageModel {
		public abstract bool has_trigram (Kkc.LanguageModelEntry ppentry, Kkc.LanguageModelEntry pentry, Kkc.LanguageModelEntry entry);
		public abstract double trigram_cost (Kkc.LanguageModelEntry ppentry, Kkc.LanguageModelEntry pentry, Kkc.LanguageModelEntry entry);
		public double trigram_backoff_cost (Kkc.LanguageModelEntry ppentry, Kkc.LanguageModelEntry pentry, Kkc.LanguageModelEntry entry);
	}
	[CCode (cheader_filename = "libkkc/libkkc-internals.h")]
	internal interface CommandHandler : GLib.Object {
		public abstract bool call (string? command, Kkc.State state, Kkc.KeyEvent key);
	}
	[CCode (cheader_filename = "libkkc/libkkc-internals.h")]
	public interface Dictionary : GLib.Object {
		public abstract void reload () throws GLib.Error;
		public virtual void save () throws GLib.Error;
	}
	[CCode (cheader_filename = "libkkc/libkkc-internals.h")]
	public interface SegmentDictionary : GLib.Object, Kkc.Dictionary {
		public abstract bool lookup_candidates (string midasi, bool okuri, out Kkc.Candidate[] candidates);
		public abstract string[] complete (string midasi);
		public virtual bool select_candidate (Kkc.Candidate candidate);
		public virtual bool purge_candidate (Kkc.Candidate candidate);
	}
	[CCode (cheader_filename = "libkkc/libkkc-internals.h")]
	public interface SentenceDictionary : GLib.Object, Kkc.Dictionary {
		public abstract bool lookup_constraint (string input, out int[] constraint);
		public abstract bool lookup_phrase (string[] input, out string[] phrase);
		public virtual bool select_segments (Kkc.Segment[] input);
	}
	[CCode (cheader_filename = "libkkc/libkkc-internals.h")]
	internal interface Template : GLib.Object {
		public abstract string expand (string text);
		public abstract string source { get; set construct; }
		public abstract bool okuri { get; set construct; }
	}
	[CCode (cheader_filename = "libkkc/libkkc-internals.h")]
	internal interface IndexFile : GLib.Object {
	...
	[CCode (cheader_filename = "libkkc/libkkc-internals.h")]
	internal struct KeymapCommandEntry {
		public string name;
		public string label;
	}
	[CCode (cheader_filename = "libkkc/libkkc-internals.h")]
	public struct KeymapEntry {
		public Kkc.KeyEvent key;
		public string? command;
	}
	[CCode (cheader_filename = "libkkc/libkkc-internals.h")]
	internal struct KeynameEntry {
		public uint keyval;
		public string name;
	}
	[CCode (cheader_filename = "libkkc/libkkc-internals.h")]
	internal struct RomKanaEntry {
		...
		public string hiragana_partial;
		public string katakana_partial;
		public string get_kana (Kkc.KanaMode mode, bool partial);
	}
	[CCode (cheader_filename = "libkkc/libkkc-internals.h")]
	...
	internal struct ExpressionNode {
		public Kkc.ExpressionNodeType type;
		public Gee.LinkedList<Kkc.ExpressionNode?> nodes;
		public string data;
		public ExpressionNode (Kkc.ExpressionNodeType type);
	}
	[CCode (cheader_filename = "libkkc/libkkc-internals.h")]
	...
	[CCode (cheader_filename = "libkkc/libkkc-internals.h")]
	internal delegate bool CommandCallback (string? command, Kkc.State state, Kkc.KeyEvent key);
	[CCode (cheader_filename = "libkkc/libkkc-internals.h")]
	public static bool use_mapped_index_file;
	[CCode (cheader_filename = "libkkc/libkkc-internals.h")]
	internal const Kkc.KeynameEntry[] keynames;
	[CCode (cheader_filename = "libkkc/libkkc-internals.h")]
	internal const string[] PUNCTUATION_RULE;
	[CCode (cheader_filename = "libkkc/libkkc-internals.h")]
	internal const double MIN_UNIGRAM_COST;
	[CCode (cheader_filename = "libkkc/libkkc-internals.h")]
	internal const double DECODER_MAX_DISTANCE;
	[CCode (cheader_filename = "libkkc/libkkc-internals.h")]
	internal const double DECODER_MIN_PATH_COST;
	[CCode (cheader_filename = "libkkc/libkkc-internals.h")]
	internal const int DECODER_NBEST;
	[CCode (cheader_filename = "libkkc/libkkc-internals.h")]
	internal static uint32 murmur_hash3_32 (uint32 b0, uint32 b1, uint32 seed);
	[CCode (cheader_filename = "libkkc/libkkc-internals.h")]
