/* user-segment-dictionary.c generated by valac 0.24.0.131-42e78, the Vala compiler
...
static void kkc_user_segment_dictionary_load (KkcUserSegmentDictionary* self, GError** error) {
	...
	while (TRUE) {
		...
		_tmp67_ = gee_array_list_new (KKC_TYPE_CANDIDATE, (GBoxedCopyFunc) g_object_ref, g_object_unref, NULL, NULL, NULL);
		list = _tmp67_;
		_tmp68_ = candidates;
...
static gboolean kkc_user_segment_dictionary_real_select_candidate (KkcSegmentDictionary* base, KkcCandidate* candidate) {
	...
	if (!_tmp8_) {
		...
		_tmp12_ = _tmp11_;
		_tmp13_ = gee_array_list_new (KKC_TYPE_CANDIDATE, (GBoxedCopyFunc) g_object_ref, g_object_unref, NULL, NULL, NULL);
		_tmp14_ = _tmp13_;
