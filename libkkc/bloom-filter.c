/* bloom-filter.c generated by valac 0.24.0.131-42e78, the Vala compiler
	...
	g_return_val_if_fail (self != NULL, FALSE);
	{
		...
		k = 0;
		{
			...
			while (TRUE) {
				...
				_tmp4_ = b1;
				_tmp5_ = k;
				_tmp6_ = kkc_murmur_hash3_32 (_tmp3_, _tmp4_, (guint32) _tmp5_);
				h = _tmp6_;
				_tmp7_ = h;
				_tmp8_ = self->priv->mmap;
				_tmp9_ = g_mapped_file_get_length (_tmp8_);
				i = (guint32) (_tmp7_ * ((_tmp9_ * 8) / ((gdouble) 0xFFFFFFFFLL)));
				_tmp10_ = i;
				_tmp11_ = kkc_bloom_filter_is_bit_set (self, _tmp10_);
				if (!_tmp11_) {
					result = FALSE;
					return result;
				}
