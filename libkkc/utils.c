/* utils.c generated by valac 0.21.1.40-3bbfb, the Vala compiler
...
static GeeMap* kkc_key_event_utils_keyval_to_keyname;
static GeeMap* kkc_key_event_utils_keyval_to_keyname = NULL;
static GeeMap* kkc_key_event_utils_keyname_to_keyval;
static GeeMap* kkc_key_event_utils_keyname_to_keyval = NULL;
...
static void kkc_key_event_utils_finalize (GObject* obj);
...
gchar** kkc_utils_split_utf8 (const gchar* str, int* result_length1) {
	...
	_tmp8_ = _result_;
	_tmp10_ = gee_abstract_collection_to_array ((GeeAbstractCollection*) _tmp8_, &_tmp9_);
	_tmp11_ = _tmp10_;
	...
	builder = _tmp0_;
	{
		...
		i = 0;
		{
			...
			while (TRUE) {
				...
				_tmp11_ = kkc_utils_hex_char_to_int (_tmp10_);
				_tmp12_ = hex;
				_tmp13_ = i;
				_tmp14_ = string_get (_tmp12_, (glong) (_tmp13_ + 1));
				_tmp15_ = kkc_utils_hex_char_to_int (_tmp14_);
				c = (_tmp11_ << 4) | _tmp15_;
				_tmp16_ = builder;
				_tmp17_ = c;
...
GeeList* kkc_sequence_utils_enumerate_prefixes (gchar** sequence, int sequence_length1, gint min, gint max) {
	...
	GeeArrayList* _result_ = NULL;
	GeeArrayList* _tmp0_ = NULL;
	_tmp0_ = gee_array_list_new (KKC_TYPE_PREFIX_ENTRY, (GBoxedCopyFunc) kkc_prefix_entry_dup, kkc_prefix_entry_free, NULL);
	_result_ = _tmp0_;
	{
		gint i = 0;
		i = 0;
				...
				}
				{
					...
					j = _tmp6__length1;
					{
						...
						while (TRUE) {
							...
							KkcPrefixEntry _tmp24_ = {0};
							KkcPrefixEntry _tmp25_ = {0};
							_tmp8_ = _tmp7_;
							if (!_tmp8_) {
								gint _tmp9_ = 0;
								_tmp9_ = j;
							...
							_tmp21_ = i;
							_tmp22_ = j;
							kkc_prefix_entry_init (&_tmp23_, _tmp19_, _tmp20_ + _tmp21_, _tmp22_ - _tmp21_);
							_tmp24_ = _tmp23_;
							_tmp25_ = _tmp24_;
							gee_abstract_collection_add ((GeeAbstractCollection*) _tmp18_, &_tmp25_);
							kkc_prefix_entry_destroy (&_tmp24_);
						}
					}
				}
			}
...
gchar* kkc_key_event_utils_keyval_name (guint keyval) {
	...
	_tmp0_ = kkc_key_event_utils_keyval_to_keyname;
	_tmp1_ = keyval;
...
guint kkc_key_event_utils_keyval_from_name (const gchar* name) {
	...
	_tmp0_ = kkc_key_event_utils_keyname_to_keyval;
	_tmp1_ = name;
	...
	if (_tmp2_) {
		...
		_tmp3_ = kkc_key_event_utils_keyname_to_keyval;
		_tmp4_ = name;
		_tmp5_ = gee_map_get (_tmp3_, _tmp4_);
		result = (guint) ((guintptr) _tmp5_);
		return result;
	}
	_tmp6_ = name;
	...
	if (_tmp7_ == 1) {
		...
		code = _tmp9_;
		_tmp11_ = code;
		if (((gunichar) 0x20) <= _tmp11_) {
			gunichar _tmp12_ = 0U;
			_tmp12_ = code;
			_tmp10_ = _tmp12_ < ((gunichar) 0x7F);
		} else {
			_tmp10_ = FALSE;
		}
		_tmp13_ = _tmp10_;
...
gunichar kkc_key_event_utils_keyval_unicode (guint keyval) {
	...
	switch (_tmp5_) {
		...
		{
			gunichar _tmp6_ = 0U;
			_tmp6_ = string_get_char ("\xc2\xa5", (glong) 0);
			result = _tmp6_;
			return result;
		}
		default:
...
static void kkc_key_event_utils_class_init (KkcKeyEventUtilsClass * klass) {
	...
	G_OBJECT_CLASS (klass)->finalize = kkc_key_event_utils_finalize;
	_tmp0_ = gee_hash_map_new (G_TYPE_UINT, NULL, NULL, G_TYPE_STRING, (GBoxedCopyFunc) g_strdup, g_free, NULL, NULL, NULL);
	kkc_key_event_utils_keyval_to_keyname = (GeeMap*) _tmp0_;
	_tmp1_ = gee_hash_map_new (G_TYPE_STRING, (GBoxedCopyFunc) g_strdup, g_free, G_TYPE_UINT, NULL, NULL, NULL, NULL, NULL);
	kkc_key_event_utils_keyname_to_keyval = (GeeMap*) _tmp1_;
	{
		KkcKeynameEntry* entry_collection = NULL;
		gint entry_collection_length1 = 0;
		gint _entry_collection_size_ = 0;
		gint entry_it = 0;
		entry_collection = KKC_keynames;
		entry_collection_length1 = G_N_ELEMENTS (KKC_keynames);
		for (entry_it = 0; entry_it < G_N_ELEMENTS (KKC_keynames); entry_it = entry_it + 1) {
			KkcKeynameEntry entry = {0};
			entry = entry_collection[entry_it];
			{
				GeeMap* _tmp2_ = NULL;
				KkcKeynameEntry _tmp3_ = {0};
				guint _tmp4_ = 0U;
				KkcKeynameEntry _tmp5_ = {0};
				const gchar* _tmp6_ = NULL;
				_tmp2_ = kkc_key_event_utils_keyval_to_keyname;
				_tmp3_ = entry;
				_tmp4_ = _tmp3_.keyval;
				_tmp5_ = entry;
				_tmp6_ = _tmp5_.name;
				gee_map_set (_tmp2_, (gpointer) ((guintptr) _tmp4_), _tmp6_);
			}
		}
	}
	{
		...
		for (entry_it = 0; entry_it < G_N_ELEMENTS (KKC_keynames); entry_it = entry_it + 1) {
			...
			{
				GeeMap* _tmp7_ = NULL;
				KkcKeynameEntry _tmp8_ = {0};
				const gchar* _tmp9_ = NULL;
				KkcKeynameEntry _tmp10_ = {0};
				guint _tmp11_ = 0U;
				_tmp7_ = kkc_key_event_utils_keyname_to_keyval;
				_tmp8_ = entry;
				_tmp9_ = _tmp8_.name;
				_tmp10_ = entry;
				_tmp11_ = _tmp10_.keyval;
				gee_map_set (_tmp7_, _tmp9_, (gpointer) ((guintptr) _tmp11_));
			}
		}
	}
}
...
static void kkc_key_event_utils_finalize (GObject* obj) {
	KkcKeyEventUtils * self;
	self = G_TYPE_CHECK_INSTANCE_CAST (obj, KKC_TYPE_KEY_EVENT_UTILS, KkcKeyEventUtils);
	G_OBJECT_CLASS (kkc_key_event_utils_parent_class)->finalize (obj);
}
