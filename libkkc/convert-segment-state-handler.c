/* convert-segment-state-handler.c generated by valac 0.21.1.40-3bbfb, the Vala compiler
...
static gboolean _kkc_convert_segment_state_handler_do_next_candidate_kkc_command_callback (const gchar* command, KkcState* state, KkcKeyEvent* key, gpointer self) {
	gboolean result;
	result = kkc_convert_segment_state_handler_do_next_candidate (self, command, state, key);
	return result;
}
...
static gboolean _kkc_convert_segment_state_handler_do_previous_candidate_kkc_command_callback (const gchar* command, KkcState* state, KkcKeyEvent* key, gpointer self) {
	gboolean result;
	result = kkc_convert_segment_state_handler_do_previous_candidate (self, command, state, key);
	return result;
}
...
static gboolean _kkc_convert_segment_state_handler_do_purge_candidate_kkc_command_callback (const gchar* command, KkcState* state, KkcKeyEvent* key, gpointer self) {
	gboolean result;
	result = kkc_convert_segment_state_handler_do_purge_candidate (self, command, state, key);
	return result;
}
...
static gboolean _kkc_convert_segment_state_handler_do_clear_unhandled_kkc_command_callback (const gchar* command, KkcState* state, KkcKeyEvent* key, gpointer self) {
	gboolean result;
	result = kkc_convert_segment_state_handler_do_clear_unhandled (self, command, state, key);
	return result;
}
...
static gboolean _kkc_convert_segment_state_handler_do_select_unhandled_kkc_command_callback (const gchar* command, KkcState* state, KkcKeyEvent* key, gpointer self) {
	gboolean result;
	result = kkc_convert_segment_state_handler_do_select_unhandled (self, command, state, key);
	return result;
}
		...
		i = _tmp2_;
		{
			...
			while (TRUE) {
				...
				if (_tmp13_ != NULL) {
					...
					_tmp17_ = _tmp16_;
					kkc_state_handler_register_command_callback ((KkcStateHandler*) self, _tmp17_, _kkc_convert_segment_state_handler_do_clear_unhandled_kkc_command_callback, self);
					_g_free0 (_tmp17_);
				}
				_g_free0 (enum_value);
			}
...
static void kkc_convert_segment_state_handler_class_init (KkcConvertSegmentStateHandlerClass * klass) {
	...
	KKC_STATE_HANDLER_CLASS (klass)->process_key_event = kkc_convert_segment_state_handler_real_process_key_event;
