/* dictionary-list.c generated by valac 0.24.0.131-42e78, the Vala compiler
...
#line 5 "/home/ueno/devel/libkkc/tests/dictionary-list.vala"
	dictionary_list_tests_test_properties ((DictionaryListTests*) self);
...
#line 6 "/home/ueno/devel/libkkc/tests/dictionary-list.vala"
	dictionary_list_tests_test_collection ((DictionaryListTests*) self);
...
#line 15 "/home/ueno/devel/libkkc/tests/dictionary-list.vala"
				if (!_tmp5_) {
#line 162 "dictionary-list.c"
					gint _tmp6_ = 0;
#line 15 "/home/ueno/devel/libkkc/tests/dictionary-list.vala"
					_tmp6_ = i;
#line 15 "/home/ueno/devel/libkkc/tests/dictionary-list.vala"
					i = _tmp6_ + 1;
#line 168 "dictionary-list.c"
				}
#line 15 "/home/ueno/devel/libkkc/tests/dictionary-list.vala"
				_tmp5_ = FALSE;
#line 15 "/home/ueno/devel/libkkc/tests/dictionary-list.vala"
...
#line 15 "/home/ueno/devel/libkkc/tests/dictionary-list.vala"
				_tmp8_ = enum_class;
#line 15 "/home/ueno/devel/libkkc/tests/dictionary-list.vala"
				_tmp9_ = _tmp8_->maximum;
#line 15 "/home/ueno/devel/libkkc/tests/dictionary-list.vala"
				if (!(_tmp7_ <= _tmp9_)) {
#line 15 "/home/ueno/devel/libkkc/tests/dictionary-list.vala"
					break;
#line 182 "dictionary-list.c"
				}
#line 16 "/home/ueno/devel/libkkc/tests/dictionary-list.vala"
				_tmp10_ = enum_class;
#line 16 "/home/ueno/devel/libkkc/tests/dictionary-list.vala"
				_tmp11_ = i;
#line 16 "/home/ueno/devel/libkkc/tests/dictionary-list.vala"
				_tmp12_ = g_enum_get_value (_tmp10_, _tmp11_);
#line 16 "/home/ueno/devel/libkkc/tests/dictionary-list.vala"
				_tmp13_ = __g_enum_value_dup0 (_tmp12_);
#line 16 "/home/ueno/devel/libkkc/tests/dictionary-list.vala"
				enum_value = _tmp13_;
#line 17 "/home/ueno/devel/libkkc/tests/dictionary-list.vala"
				_tmp14_ = enum_value;
#line 17 "/home/ueno/devel/libkkc/tests/dictionary-list.vala"
				_vala_assert (_tmp14_ != NULL, "enum_value != null");
#line 15 "/home/ueno/devel/libkkc/tests/dictionary-list.vala"
				_g_free0 (enum_value);
#line 200 "dictionary-list.c"
			}
		}
	}
#line 9 "/home/ueno/devel/libkkc/tests/dictionary-list.vala"
...
static void dictionary_list_tests_test_collection (DictionaryListTests* self) {
	...
	KkcDictionary* _tmp12_ = NULL;
	gint _tmp13_ = 0;
	gint _tmp14_ = 0;
	KkcEmptySegmentDictionary* empty_dictionary = NULL;
	KkcEmptySegmentDictionary* _tmp15_ = NULL;
	gint _tmp16_ = 0;
	gint _tmp17_ = 0;
	gint _tmp18_ = 0;
	gint _tmp19_ = 0;
...
#line 236 "dictionary-list.c"
	{
		...
		KkcSystemSegmentDictionary* _tmp8_ = NULL;
...
#line 28 "/home/ueno/devel/libkkc/tests/dictionary-list.vala"
		system_segment_dictionary = (KkcDictionary*) _tmp8_;
#line 25 "/home/ueno/devel/libkkc/tests/dictionary-list.vala"
		_g_object_unref0 (_tmp3_);
#line 25 "/home/ueno/devel/libkkc/tests/dictionary-list.vala"
		_g_free0 (srcdir);
#line 286 "dictionary-list.c"
	}
	goto __finally0;
	__catch0_g_error:
	{
...
#line 25 "/home/ueno/devel/libkkc/tests/dictionary-list.vala"
		return;
#line 324 "dictionary-list.c"
	}
#line 33 "/home/ueno/devel/libkkc/tests/dictionary-list.vala"
	_tmp12_ = system_segment_dictionary;
#line 33 "/home/ueno/devel/libkkc/tests/dictionary-list.vala"
	kkc_dictionary_list_add (dictionaries, _tmp12_);
#line 34 "/home/ueno/devel/libkkc/tests/dictionary-list.vala"
	_tmp13_ = kkc_dictionary_list_get_size (dictionaries);
#line 34 "/home/ueno/devel/libkkc/tests/dictionary-list.vala"
	_tmp14_ = _tmp13_;
#line 34 "/home/ueno/devel/libkkc/tests/dictionary-list.vala"
	_vala_assert (_tmp14_ == 1, "dictionaries.size == 1");
#line 36 "/home/ueno/devel/libkkc/tests/dictionary-list.vala"
	_tmp15_ = kkc_empty_segment_dictionary_new ();
#line 36 "/home/ueno/devel/libkkc/tests/dictionary-list.vala"
	empty_dictionary = _tmp15_;
...
#line 38 "/home/ueno/devel/libkkc/tests/dictionary-list.vala"
	_tmp16_ = kkc_dictionary_list_get_size (dictionaries);
#line 38 "/home/ueno/devel/libkkc/tests/dictionary-list.vala"
	_tmp17_ = _tmp16_;
#line 38 "/home/ueno/devel/libkkc/tests/dictionary-list.vala"
	_vala_assert (_tmp17_ == 2, "dictionaries.size == 2");
...
#line 41 "/home/ueno/devel/libkkc/tests/dictionary-list.vala"
	_tmp18_ = kkc_dictionary_list_get_size (dictionaries);
#line 41 "/home/ueno/devel/libkkc/tests/dictionary-list.vala"
	_tmp19_ = _tmp18_;
#line 41 "/home/ueno/devel/libkkc/tests/dictionary-list.vala"
	_vala_assert (_tmp19_ == 1, "dictionaries.size == 1");
...
#line 44 "/home/ueno/devel/libkkc/tests/dictionary-list.vala"
	_tmp20_ = kkc_dictionary_list_get_size (dictionaries);
#line 44 "/home/ueno/devel/libkkc/tests/dictionary-list.vala"
	_tmp21_ = _tmp20_;
#line 44 "/home/ueno/devel/libkkc/tests/dictionary-list.vala"
	_vala_assert (_tmp21_ == 0, "dictionaries.size == 0");
#line 21 "/home/ueno/devel/libkkc/tests/dictionary-list.vala"
